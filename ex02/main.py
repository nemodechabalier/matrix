"""Exercice 02 - Linear Interpolation (Lerp).

Ce module teste l'interpolation linéaire entre deux valeurs :
lerp(u, v, t) = u + t × (v - u)

Fonctionne avec des scalaires, vecteurs et matrices.
"""
...
def main():
    """Fonction principale pour tester l'interpolation linéaire.
    
    Teste lerp avec des scalaires, vecteurs et matrices réels et complexes.
    """
