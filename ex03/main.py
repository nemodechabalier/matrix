...
Ce module teste le produit scalaire (dot product) de deux vecteurs :
u · v = Σ u[i] × conj(v[i])
...
def main():
    """Fonction principale pour tester le produit scalaire.
    
    Teste le dot product avec des vecteurs réels et complexes.
    """
    print("=" * 50)
