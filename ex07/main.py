"""Exercice 07 - Matrix Multiplication.

Ce module teste la multiplication matricielle :
- Matrice × Vecteur (mul_vec)
- Matrice × Matrice (mul_mat)
"""
...
def main():
    """Fonction principale pour tester la multiplication matricielle.
    
    Teste mul_vec et mul_mat avec des matrices réelles et complexes.
    """
