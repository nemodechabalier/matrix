...
Ce module teste les trois normes vectorielles :
- Norme L1 (Manhattan) : ||v||₁ = Σ |v[i]|
- Norme L2 (Euclidienne) : ||v||₂ = √(Σ |v[i]|²)
- Norme infinie (Supremum) : ||v||∞ = max(|v[i]|)
"""
...
def main():
    """Fonction principale pour tester les normes vectorielles.
    
    Teste norm_1, norm et norm_inf avec des vecteurs réels et complexes.
    """
