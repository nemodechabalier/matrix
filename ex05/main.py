...
Ce module teste le calcul du cosinus de l'angle entre deux vecteurs :
cos(θ) = (u · v) / (||u|| × ||v||)
"""
...
def main():
    """Fonction principale pour tester le cosinus d'angle.
    
    Teste angle_cos avec des vecteurs réels et complexes.
    """
